...
namespace Clypeus.Data.Model.Migrations
{
    ...
    [Migration("20200424183742_fixing the foreign keys")]
    partial class fixingtheforeignkeys
    {
            ...
            modelBuilder.Entity("Clypeus.Data.Model.DrugGroup", b =>
                {
                    ...
                    b.Property<DateTime?>("Inserted")
                        ...
                        .HasDefaultValue(new DateTime(2020, 4, 24, 19, 37, 42, 550, DateTimeKind.Local).AddTicks(7630));

                    b.Property<DateTime?>("Updated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2020, 4, 24, 19, 37, 42, 556, DateTimeKind.Local).AddTicks(8267));
            ...
            modelBuilder.Entity("Clypeus.Data.Model.Drugs", b =>
                {
                    ...
                    b.HasOne("Clypeus.Data.Model.DrugGroup", "PrincipleDrugGroup")
                        .WithMany("Drugs")
