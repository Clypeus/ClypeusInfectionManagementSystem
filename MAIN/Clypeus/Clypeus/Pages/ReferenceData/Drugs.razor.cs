...
{
    public class DrugsRazorModel : ComponentBase
    {
        protected IEnumerable<DrugsViewModel> drugs;
        [Inject] protected IDrugService DrugService { get; set; }
        ...
        {
            var results = DrugService.GetDrugs(1, false, FilterString, p, 15, sortColumn, sortAscending).Result;
